...
We combine data from external services with in-platform signals to calculate your Alpha Score:

- **External Performance Data**\
  We aggregate influence and engagement signals from external platforms and analytics providers.
- **Invite Bonus**\
  Every person who joins via your invite link boosts your Alpha Score. No hard limits.
- **Partner Boost**\
  Additional boost applied if you joined via an Alpha Partner or partner project link.
...
**What if I have no external stats?**\
...
## Earning Løøkz in Alpha

Once you're inside 3look Alpha you'll start earning Løøkz.

Please note that your Løøkz balance may be adjusted when we move into Beta. What you earn in Alpha will still count and remain important for your future rewards and eligibility.